...
def handle_nutrition(api_key: str, prompt: str, history: list, file_data: dict = None, profile: dict = None) -> str:
    ...
    system_instruction = f"""You are an evidence-based maternal healthcare AI assistant specializing in balanced nutrition, proteins, hydration, pregnancy-safe supplements (like iron, prenatal vitamins), safe caffeine/coffee thresholds, and meal choices.
    ...
    try:
        ...
        print(f"[Nutrition Agent] Error: {e}")
        return f"Error executing nutrition agent: {e}"
