...
def handle_pregnancy(api_key: str, prompt: str, history: list, file_data: dict = None, profile: dict = None) -> str:
    ...
    system_instruction = f"""You are an evidence-based maternal healthcare AI assistant specializing in baby milestone development, trimester indicators, safe activities, milestones, and safe baby growth.
    ...
    try:
        ...
        print(f"[Pregnancy Agent] Error: {e}")
        return f"Error executing pregnancy agent: {e}"
